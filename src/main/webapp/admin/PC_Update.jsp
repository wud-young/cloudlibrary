            ...
            <div class="modal-body">
                <form id="borrowBook">
                    <table class="table table-bordered table-striped" width="800px">
                        ...
                        <tr>
                            <td>合同id</td>
                            <td><input class="form-control" readonly name="id" id="PCUid"></td>
                            <td>合同编号</td>
                            <td><input class="form-control" readonly name="num" id="PCUnum"></td>
                        </tr>
                        <tr>
                            <td>合同设备编号</td>
                            <td>
                                <select readonly name="PC" id="cars">
                            ...
                            <td>合同签订价格</td>
                            <td><input class="form-control" readonly name="date" id="bauthor"></td>
                        </tr>
                            <tr>
                                <td>合同签订公司</td>
                                <td><input class="form-control" readonly name="price" id="PCUprice"></td>
                                <td>合同签订人员</td>
